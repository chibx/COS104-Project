...
import type { InputEl, SessionData } from "./types";
...
export const ContactForm = {
    ...
    validateField(field: InputEl, errorMessage: string) {
    ...
    saveToSessionStorage(data: SessionData) {
        try {
